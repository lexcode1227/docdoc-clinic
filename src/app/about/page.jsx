    ...
    <>
      <section className='flex flex-col gap-8 my-10 lg:my-20 mx-5 lg:mx-[50px] xl:mx-[100px] 2xl:mx-[200px]'>
        ...
        <div className='flex flex-col md:flex-row gap-5 mb-14'>
          ...
          <p className='w-full md:max-w-[50%] text-[#5b5b5b]'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Expedita praesentium sed repellendus minima assumenda molestias magni facilis architecto reiciendis voluptates incidunt, sapiente optio magnam deleniti nisi illo cum necessitatibus esse!</p>
        </div>
