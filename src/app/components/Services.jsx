...
const Services = () => {
  ...
  return (
    <section className="flex justify-between gap-6 lg:mx-[50px] xl:mx-[100px] 2xl:mx-[200px] mt-6">
        {data.map((item)=> {
            return (
                <div className=" xl:w-[370px] xl:h-[395px] flex flex-col justify-center items-center gap-2 shadow-[0px 0px 15px 0px rgba(0, 0, 0, 0.25)] border border-solid">
