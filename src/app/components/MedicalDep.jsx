  ...
  return (
    <section className="flex justify-center items-center bg-[#EEEFFF] h-auto lg:h-[600px] ">
        <div className="flex flex-col lg:flex-row gap-5 lg:h-5/6 xl:h-3/4 mx-5 lg:mx-[50px] xl:mx-[100px]">
            <div className="flex flex-col items-start justify-between gap-6 md:gap-2 mt-12 lg:mt-0 w-full lg:w-1/2">
                ...
                <div className="flex justify-start md:justify-between flex-wrap lg:flex-nowrap gap-4 lg:gap-3 w-full md:w-[570px]">
                    {Deptos.map((item)=>{
                        return (
