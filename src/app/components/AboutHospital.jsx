...
const AboutHospital = () => {
  return (
    <section className='bg-[#EEEFFF] mt-20'>
        <div className='flex gap-3 justify-center lg:mx-[50px] xl:mx-[100px] 2xl:mx-[200px] my-9'>
            ...
            <div className='w-1/2 flex flex-col justify-center items-start gap-6'>
                <h2 className={`${rubik.className} text-[42px] text-[#2B2E35] font-bold`}>About Our <span className='text-[42px] font-bold text-[#032FF2]'>Hospital</span></h2>
